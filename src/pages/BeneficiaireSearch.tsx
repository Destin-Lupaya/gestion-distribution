...
const BeneficiaireSearch: React.FC = () => {
  ...
  const handleConfirmSelection = () => {
    ...
    // Stocker les informations du bénéficiaire dans le localStorage pour les récupérer dans le formulaire d'enregistrement manuel
    localStorage.setItem('selectedBeneficiaire', JSON.stringify({
    ...
    // Rediriger vers la page de collection des signatures avec l'onglet d'émargement manuel sélectionné
    navigate('/app/signatures?tab=1');
