/*
  # Fix import_household_data function parameter order
...
DROP FUNCTION IF EXISTS import_household_data(VARCHAR(100), VARCHAR(255), VARCHAR(50), VARCHAR(100), VARCHAR(50), INTEGER, VARCHAR(50), VARCHAR(50), VARCHAR(50), VARCHAR(100));
