...
const programmesRoutes_1 = __importDefault(require("./programmesRoutes"));
const evenementsRoutes_1 = __importDefault(require("./evenementsRoutes"));
const assistancesRoutes_1 = __importDefault(require("./assistancesRoutes"));
...
router.use('/programmes', programmesRoutes_1.default);
...
router.use('/assistances-distribuees', assistancesRoutes_1.default);
