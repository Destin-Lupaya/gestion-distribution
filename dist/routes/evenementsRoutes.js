...
router.post('/', async (req, res) => {
    try {
        ...
        const evenement_id = (0, uuid_1.v4)();
...
router.put('/:id', async (req, res) => {
    try {
        ...
        const [existingRows] = await connection.query('SELECT * FROM evenements_distribution WHERE evenement_id = ?', [id]);
...
router.delete('/:id', async (req, res) => {
    try {
        ...
        await connection.query('DELETE FROM evenements_distribution WHERE evenement_id = ?', [id]);
        await connection.end();
        res.json({
            success: true,
...
router.post('/', async (req, res) => {
    try {
        const { programme_id, site_id, date_distribution_prevue, heure_debut_prevue, heure_fin_prevue, type_assistance_prevue, quantite_totale_prevue, statut_evenement } = req.body;
...
//# sourceMappingURL=evenementsRoutes.js.map